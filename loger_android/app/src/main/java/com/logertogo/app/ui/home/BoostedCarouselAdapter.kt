...
import com.logertogo.app.databinding.ItemPropertyBoostedBinding

class BoostedCarouselAdapter(
    private val onClick: (Property) -> Unit
) : ListAdapter<Property, BoostedCarouselAdapter.ViewHolder>(DiffCallback) {

    class ViewHolder(val binding: ItemPropertyBoostedBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemPropertyBoostedBinding.inflate(
