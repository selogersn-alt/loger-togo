...
import '../widgets/boosted_carousel.dart';
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: SizedBox(
              height:
                  560, // Hauteur totale pour inclure le débordement de la carte
              child: Stack(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _buildFilterChip('VILLA', 'Villas'),
                  _buildFilterChip('APPARTEMENT', 'Appartements'),
                  _buildFilterChip('TERRAIN', 'Terrains'),
                  _buildFilterChip('STUDIO', 'Studios'),
                ],
              ),
            ),
          ),
          ...
          // PREMIUM CAROUSEL
          SliverToBoxAdapter(
            child: ValueListenableBuilder<PagingState<int, Property>>(
              valueListenable: _pagingController,
              builder: (context, state, child) {
                final allItems = state.itemList ?? [];
                final boosted = allItems.where((p) => p.isBoosted).take(5).toList();
                
                if (boosted.isEmpty) return const SizedBox.shrink();
                
                return Padding(
                  padding: const EdgeInsets.only(bottom: 24),
                  child: BoostedCarousel(
                    properties: boosted,
  ...
  Widget _buildFilterChip(String value, String label) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        _selectedType = value == 'TOUS' ? 'TOUT' : value;
        _pagingController.refresh();
      },
      child: Container(
